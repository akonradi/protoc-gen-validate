...
var floatCases = []TestCase{
	...
	{"float - gt & lt - no mask - valid (max)", &cases.FloatGTLT{Val: 10, UpdateMask: mkMask()}, true},
	{"float - gt & lt - no mask - valid (min)", &cases.FloatGTLT{Val: 0, UpdateMask: mkMask()}, true},
	...
	{"float - gt & lt - in mask - invalid (max)", &cases.FloatGTLT{Val: 10, UpdateMask: mkMask("val")}, false},
	{"float - gt & lt - in mask - invalid (min)", &cases.FloatGTLT{Val: 0, UpdateMask: mkMask("val")}, false},
	...
	{"float - exclusive gt & lt - no mask - valid (max)", &cases.FloatExLTGT{Val: 10, UpdateMask: mkMask()}, true},
	{"float - exclusive gt & lt - no mask - valid (min)", &cases.FloatExLTGT{Val: 0, UpdateMask: mkMask()}, true},
	{"float - exclusive gt & lt - in mask - invalid", &cases.FloatExLTGT{Val: 5, UpdateMask: mkMask("val")}, false},
	{"float - exclusive gt & lt - in mask - invalid (max)", &cases.FloatExLTGT{Val: 10, UpdateMask: mkMask("val")}, false},
	{"float - exclusive gt & lt - in mask - invalid (min)", &cases.FloatExLTGT{Val: 0, UpdateMask: mkMask("val")}, false},
...
var messageCases = []TestCase{
	...
	{"message - field - in mask - invalid", &cases.Message{Val: &cases.TestMsg{}, UpdateMask: mkMask("val.const")}, false},
