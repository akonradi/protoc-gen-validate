...
# Auto-generated list of repositories. Gazelle populates this from go.mod. To update, run the
# following from the repository root:
#
#   bazel run @bazel_gazelle//:gazelle -- update-repos \
#      -from_file=go.mod -to_macro=bazel/dependency_imports.bzl%go_repositories
#
def go_repositories():
    go_repository(
